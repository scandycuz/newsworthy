...
define('frontend/tests/controllers/articles.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | controllers/articles.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
...
define('frontend/tests/unit/routes/article-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
