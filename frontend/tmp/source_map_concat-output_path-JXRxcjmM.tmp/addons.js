...
define('ember-font-awesome/components/fa-icon', ['exports', 'ember', 'ember-computed-decorators', 'ember-font-awesome/utils/try-match', 'ember-font-awesome/utils/optional-decorator'], function (exports, _ember, _emberComputedDecorators, _emberFontAwesomeUtilsTryMatch, _emberFontAwesomeUtilsOptionalDecorator) {
  ...
  var FaIconComponent = _ember['default'].Component.extend(_createDecoratedObject([{
    ...
    initializer: function initializer() {
      return ['ariaHiddenAttribute:aria-hidden', 'title', 'style'];
    }
  }, {
    key: 'style',
    decorators: [_emberFontAwesomeUtilsOptionalDecorator['default'], (0, _emberComputedDecorators['default'])('color')],
...
define("ember-font-awesome/templates/components/fa-list", ["exports"], function (exports) {
  ...
  exports["default"] = Ember.HTMLBars.template({ "id": "Q7UQpNOn", "block": "{\"statements\":[[\"yield\",\"default\",[[\"helper\",[\"hash\"],null,[[\"fa-icon\"],[[\"helper\",[\"component\"],[\"fa-icon\"],[[\"listItem\"],[true]]]]]]]],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "modules/ember-font-awesome/templates/components/fa-list.hbs" } });
});
define("ember-font-awesome/templates/components/fa-stack", ["exports"], function (exports) {
  "use strict";

  exports["default"] = Ember.HTMLBars.template({ "id": "95rirqq3", "block": "{\"statements\":[[\"yield\",\"default\",[[\"helper\",[\"hash\"],null,[[\"stack-1x\",\"stack-2x\"],[[\"helper\",[\"component\"],[\"fa-icon\"],[[\"stack\"],[\"1\"]]],[\"helper\",[\"component\"],[\"fa-icon\"],[[\"stack\"],[\"2\"]]]]]]]],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "modules/ember-font-awesome/templates/components/fa-stack.hbs" } });
});
